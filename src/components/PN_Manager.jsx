...
import PNM1 from "./PN_1";
import PNM2 from "./PN_2";
import PNM3 from "./PN_3";
import PNM4 from "./PN_4";
import { useForm } from "react-hook-form";

function ProgressNotesManager({ data, show, setShow, containerName }) {
  ...
  const renderPage = () => {
    switch (activePage) {
      case 0:
        return <PNM1 register={register} control={control} />;
      case 1:
        return <PNM2 register={register} control={control} />;
      case 2:
        return <PNM3 register={register} control={control} />;
      case 3:
        return <PNM4 register={register} control={control} />;
      default:
        return <PNM1 register={register} control={control} />;
    }
  };
...
export default ProgressNotesManager;
