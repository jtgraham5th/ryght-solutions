  ...
  return (
    <>
      ...
      <Form.Group as={Row} className="mb-2">
        ...
        <Col md={4}>
          <Form.Label className="CE-form-label">Work Phone</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("workPhone")}
            type="number"
      ...
      <Form.Group as={Row} className="mb-2">
        <Form.Label className="CE-form-label mb-2">Household:</Form.Label>
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={3} className="d-flex flex-column">
          <Form.Label className="CE-form-label mb-2">Mother:</Form.Label>
          <InputGroup size="sm">
            <InputGroup.Radio
              name="parents-mother"
        ...
        <Col md={3} className="d-flex flex-column">
          <Form.Label className="CE-form-label mb-2">Father:</Form.Label>
          <InputGroup size="sm">
            <InputGroup.Radio
              name="parents-father"
              aria-label="Radio button for following text input"
        ...
        <Col md={3} className="d-flex flex-column">
          <Form.Label className="CE-form-label mb-2">Step-Mother:</Form.Label>
          <InputGroup size="sm">
            <InputGroup.Radio
        ...
        <Col md={3} className="d-flex flex-column">
          <Form.Label className="CE-form-label mb-2">Step-Father:</Form.Label>
          <InputGroup size="sm">
            <InputGroup.Radio
      ...
      <Form.Group as={Row} className="mb-2 align-items-center">
        <Col md={5}>
          ...
          {/* <Form.Label className="CE-form-label">Name</Form.Label> */}
        </Col>
        <Col md={2}>
          <InputGroup size="sm">
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={4}>
          <Form.Label className="CE-form-label">Brothers Ages</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("brothers")}
            type="text"
        ...
        <Col md={4}>
          <Form.Label className="CE-form-label">Sisters Ages</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("sisters")}
            type="text"
