...
function SA2({ register, control }) {
  ...
  return (
    <>
      ...
      <Form.Group as={Row} className="mb-2">
        <Form.Label className="CE-form-label mb-2">Communication</Form.Label>
        <div>
          <Form.Check
            inline
      ...
      <Form.Group as={Row} className="mb-2">
        ...
        <Col md={4}>
          <Form.Label className="CE-form-label">Years of Service?</Form.Label>
          <Form.Control
            className="goal-detail-input"
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={12}>
          <Form.Label className="CE-form-label">Spiritual/Religious Background</Form.Label>
          <Form.Control
            className="goal-detail-input"
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={12}>
          <Form.Label className="CE-form-label">Cultural Background</Form.Label>
          <Form.Control
            className="goal-detail-input"
      ...
      <Form.Group as={Row} className="mb-2">
        <Form.Label className="CE-form-label mb-2">Referral Source</Form.Label>
        <div>
          <Form.Check
            inline
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={4}>
          <Form.Label className="CE-form-label">Contact Name</Form.Label>
          <Form.Control
            className="goal-detail-input"
