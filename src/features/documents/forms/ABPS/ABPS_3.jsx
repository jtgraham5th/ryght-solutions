  ...
  return (
    <>
      ...
      <Form.Group as={Row} className="mb-2">
        ...
        <Col md={5}>
          <Form.Label className="RQ-form-label">Past Conditions</Form.Label>
          <Form.Control
        ...
        <Col md={2}>
          <Form.Label className="RQ-form-label">Date of Onset</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f2")}
            type="text"
        ...
        <Col md={5}>
          <Form.Label className="RQ-form-label">Residual Effects</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f3")}
            type="text"
