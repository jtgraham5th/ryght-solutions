  ...
  return (
    <>
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={4}>
          <Form.Label className="RQ-form-label">Client Name</Form.Label>
          <Form.Control
        ...
        <Col md={4}>
          <Form.Label className="RQ-form-label">Assessment Date</Form.Label>
          <Controller
            control={control}
            name="f2"
        ...
        <Col md={4}>
          <Form.Label className="RQ-form-label">Assessor Name</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f3")}
            type="text"
      ...
      <Form.Group as={Row} className="mb-2">
        ...
        <Col md={3}>
          <Form.Label className="RQ-form-label">Age</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f12")}
            type="text"
        ...
        <Col md={3}>
          <Form.Label className="RQ-form-label">Race</Form.Label>
          <Form.Select
            {...register("f13")}
            name="f13"
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={6}>
          <Form.Label className="RQ-form-label">Social Security #</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f15")}
            type="password"
        ...
        <Col md={6}>
          <Form.Label className="RQ-form-label">Current Address</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f16")}
            type="password"
      ...
      <Form.Group as={Row} className="mb-4">
        <Col md={4}>
          <Form.Label className="RQ-form-label">Emergency Contact</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f17")}
            type="password"
        ...
        <Col md={4}>
          <Form.Label className="RQ-form-label">Relationship</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f18")}
            type="password"
        ...
        <Col md={4}>
          <Form.Label className="RQ-form-label">Contact Telephone</Form.Label>
          <Form.Control
            className="goal-detail-input"
            {...register("f19")}
            type="password"
