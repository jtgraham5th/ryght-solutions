...
function SA3({ register, control }) {
  ...
  return (
    <>
      ...
      <Form.Group as={Row} className="mb-2">
        <Col md={12}>
          <Form.Label className="RQ-form-label">Medical Problems</Form.Label>
          <Form.Control
      ...
      <Form.Group as={Row} className="mb-2">
        ...
        <Col md={7}>
          <Form.Label className="RQ-form-label">If yes, explain:</Form.Label>
          <Form.Control
            className="goal-detail-input"
      ...
      <Form.Group as={Row} className="mb-4">
        ...
        <Col md={4}>
          <Form.Label className="RQ-form-label">If yes, how often:</Form.Label>
          <Form.Control
            className="goal-detail-input"
      ...
      <Form.Group as={Row} className="mb-4">
        <Form.Label className="RQ-form-label mb-2">Legal Custody</Form.Label>
        <div>
          <Form.Check
            inline
