// Mock data used when the external API is unavailable (e.g. GitHub Pages demo)
export const mockData = {
  ...
  groupNames: [
    ...
    },
    {
      ...
      name: "Services",
      groupname: "Services",
      description: "Service offerings available to clients",
    },
  ],
  ...
  progressNotes: [
    {
      ...
      billingid: 1,
      content:
        "Patient reported improved mood this week. Discussed coping strategies for work stress.",
    ...
    },
    {
      ...
      billingid: 2,
      content:
        "Continued progress with depression symptoms. Patient engaged well in session.",
  ...
  documents: [
    {
      ...
      docid: 2,
      billingid: 1,
      content: "Progress note for therapy session on 2024-08-15",
      createdate: "2024-08-15",
      userid: 2,
    },
  ],
